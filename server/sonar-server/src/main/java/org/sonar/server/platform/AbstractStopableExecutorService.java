...
/**
 * Abstract implementation of StopableExecutorService that implements the
 * stop() method and delegates all methods to the provided ExecutorService instance.
 */
public abstract class AbstractStopableExecutorService implements StopableExecutorService {
  private final ExecutorService delegate;

  public AbstractStopableExecutorService(ExecutorService delegate) {
